...
gh label create "phase:1" --color "1D76DB" --description "Phase 1 — Markov Foundations" --repo "$REPO" --force
gh label create "phase:2" --color "5319E7" --description "Phase 2 — Stationary Distributions" --repo "$REPO" --force
gh label create "phase:3" --color "D93F0B" --description "Phase 3 — Absorption & Hitting Times" --repo "$REPO" --force
gh label create "phase:4" --color "FBCA04" --description "Phase 4 — Continuous-Time" --repo "$REPO" --force
gh label create "phase:5" --color "B60205" --description "Phase 5 — Applied Headcount Model" --repo "$REPO" --force
gh label create "phase:6" --color "006B75" --description "Phase 6 — Experiments & Visualizations" --repo "$REPO" --force
gh label create "phase:7" --color "1D76DB" --description "Phase 7 — Article Writing" --repo "$REPO" --force
gh label create "phase:8" --color "0E8A16" --description "Phase 8 — Review & Publish" --repo "$REPO" --force
